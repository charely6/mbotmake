...
Download the entire zip file, extract it, and install python 3.12

# Usage


Example usages in command line

Replicator 5 with a smart extruder
```python.exe mbotmake print.gcode```

Replicator+ with a smart extruder plus 
```python.exe mbotmake -RepPlus -SmartExtPlus print.gode```
